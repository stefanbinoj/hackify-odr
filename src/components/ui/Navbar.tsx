      ...
      <div className="w-full md:my-auto">
        <div className="relative flex items-center justify-between">
          <Link
            ...
            aria-label="Home"
          >
            <span className="sr-only">RESOLV ODR Logo</span>
            <SolarLogo className="w-22" />
            <h1 className="ml-[-45px] bg-gradient-to-b from-orange-600 to-orange-400 bg-clip-text text-xl font-bold text-transparent">
              RESOLV
            </h1>
          </Link>
          ...
          <Button
            variant="secondary"
            className="h-10 rounded-xl bg-gradient-to-r from-orange-500 to-orange-500 font-semibold text-white hover:cursor-pointer"
          >
            Join now
          </Button>
          <Button
