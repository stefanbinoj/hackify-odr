  ...
  const sections = {
    solutions: {
      ...
      items: [
        ...
        { label: "Consulation", href: "#" },
        { label: "Full Analytics", href: "#" },
        { label: "Video Conference", href: "#" },
        { label: "Documentation", href: "#" },
        { label: "Chat bots", href: "#" },
        { label: "Transcipt", href: "#" },
      ],
    },
    company: {
      title: "Company",
      ...
      >
        ...
        <div className="mr-auto flex w-full justify-between lg:w-fit lg:flex-col">
          ...
          >
            ...
            <span className="sr-only">RESOLV Logo (go home)</span>
          </Link>
          ...
          <div>
            ...
            <div className="ml-2 hidden text-sm text-gray-700 lg:inline">
              &copy; {CURRENT_YEAR} RESOLV ODR Inc.
            </div>
          </div>
        </div>
