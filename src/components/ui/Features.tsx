...
export default function Features() {
  return (
    <section
      aria-label="RESOLV ODR for quick resolving"
      id="solutions"
      ...
      <div className="grid grid-cols-1 gap-12 md:grid-cols-4 md:gap-0">
        ...
        <div className="col-span-2 my-auto px-2">
          ...
          <p className="mt-2 text-3xl font-semibold tracking-tighter text-balance text-gray-900 md:text-4xl">
            Negotiate seamlessly and settle disputes digitally
          </p>
          <p className="mt-4 text-balance text-gray-700">
            Negotiate with counter-parties using our intuitive negotiation
            tools, multilingual chatbots, dynamic payment links, populate and
            exchange offers, and record terms in digital agreements
          </p>
        </div>
        ...
        <div className="col-span-2 my-auto px-2">
          ...
          <p className="mt-2 text-3xl font-semibold tracking-tighter text-balance text-gray-900 md:text-4xl">
            Mutually-beneficial resolutions in a few clicks
          </p>
          <p className="mt-4 text-balance text-gray-700">
            Leverage the power of mediation to amicably resolve your dispute and
            record terms in a binding settlement agreement / conciliation award
            facilitated by certified mediators and our powerful mediation
            platform
          </p>
        </div>
        <div className="relative col-span-2 flex items-center justify-center overflow-hidden">
        ...
        <div className="col-span-2 my-auto px-2">
          ...
          <p className="mt-2 text-3xl font-semibold tracking-tighter text-balance text-gray-900 md:text-4xl">
            Institutional e-arbitration for enforceable outcomes
          </p>
          <p className="mt-4 text-balance text-gray-700">
            While the institutional structure addresses all legal aspects, the
            platform ensures effective administration through AI-driven
            research, algorithmic case allocation, smart case management, task
            automation, digital awards, etc.
          </p>
        </div>
        <div className="relative col-span-2 flex items-center justify-center overflow-hidden">
          <svg
