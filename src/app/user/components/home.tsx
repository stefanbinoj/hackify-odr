  ...
  return (
    <>
            ...
            <div className="w-[370px] overflow-hidden rounded-xl bg-white shadow-lg">
              <div className="p-6">
                ...
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <button
                    onClick={() => setShowTrackCasesModal(true)}
                    className="mt-2 flex w-full items-center justify-between rounded-lg bg-gray-100 p-4 transition-colors hover:bg-gray-200"
                  >
                    <span className="font-medium text-gray-800">Track My Cases</span>
      ...
      <MediationModal
        ...
        onClose={() => setShowMediationModal(false)}
      />
      <ArbitrationModal
